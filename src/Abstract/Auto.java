...
public abstract class Auto implements Vehicle{
    ...
    public void book(int distance){
        ...
        System.out.println("You have booked a"+ shareType + "Auto for a distance of"+ distance +
                "kms at a total cost of "+ cost + ".");
    }

    @Override
    public int calculateCostOfBooking(int distance){
        int serviceCharge=1;
        return baseCost + distance * chargesPerUnitDistance + serviceCharge;
    }
}
